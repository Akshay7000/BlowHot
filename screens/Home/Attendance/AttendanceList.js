...
import {
  ActivityIndicator, FlatList, Linking, StyleSheet, Text, TouchableOpacity, View
} from "react-native";
            ...
            <Grid>
              <Row>
                ...
                <Col
                  ...
                  width={wp("30%")}
                >
                  <Text style={{ fontWeight: "bold" }}>Start MilloMeter</Text>
                </Col>
                <Col
                  style={{ marginRight: 20, borderRightWidth: 0.5 }}
                  width={wp("40%")}
                >
                  <Text style={{ fontWeight: "bold" }}>Start Remark</Text>
                </Col>
                ...
                <Col
                  ...
                  width={wp("40%")}
                >
                  <Text style={{ fontWeight: "bold" }}>End MilloMeter</Text>
                </Col>
                <Col
                  style={{ marginRight: 20, borderRightWidth: 0.5 }}
                  width={wp("40%")}
                >
                  <Text style={{ fontWeight: "bold" }}>End Remark</Text>
                </Col>
              </Row>
                  ...
                  <>
                    ...
                    <Row style={{ marginBottom: 10, marginTop: 10 }}>
                      ...
                      <Col
                        ...
                        width={wp("30%")}
                      >
                        <Text>{item.MilloMeterReading}</Text>
                      </Col>
                      <Col
                        style={{
                          marginRight: 20,
